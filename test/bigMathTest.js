...
const numbers = [
  ...
  new BigNumber('41'),
  new BigNumber('97'),
  MAX_UINT64.div('10000').dp(0).minus('1'),
  MAX_UINT64.div('10000').dp(0),
  MAX_UINT64.div('10000').dp(0).plus('1'),
  MAX_UINT64.div('10').dp(0).minus('1'),
  MAX_UINT64.div('10').dp(0),
  MAX_UINT64.div('10').dp(0).plus('1'),
  ...
  MAX_UINT64.plus('1'),
  MAX_UINT64.plus('2'),
  MAX_UINT64.times('2').dp(0).minus('1'),
  MAX_UINT64.times('2').dp(0),
  MAX_UINT64.times('2').dp(0).plus('1'),
  MAX_UINT64.times('10').dp(0).minus('1'),
  MAX_UINT64.times('10').dp(0),
  MAX_UINT64.times('10').dp(0).plus('1'),
  MAX_UINT64.times('10000').dp(0).minus('1'),
  MAX_UINT64.times('10000').dp(0),
  MAX_UINT64.times('10000').dp(0).plus('1'),
  ...
  MAX_UINT128.div('1000').dp(0).minus('1'),
  MAX_UINT128.div('1000').dp(0),
  MAX_UINT128.div('1000').dp(0).plus('1'),
  MAX_UINT128.div('10').dp(0).minus('1'),
  MAX_UINT128.div('10').dp(0),
  MAX_UINT128.div('10').dp(0).plus('1'),
  MAX_UINT128.div('2').dp(0).minus('1'),
  MAX_UINT128.div('2').dp(0),
  MAX_UINT128.div('2').dp(0).plus('1'),
  MAX_UINT128.minus('10001'),
  MAX_UINT128.minus('100'),
  MAX_UINT128.minus('3'),
  MAX_UINT128.minus('2'),
  MAX_UINT128.minus('1'),
  MAX_UINT128,
  ...
  // MAX_UINT128.times('10').minus('1'),
  // MAX_UINT128.times('10'),
  // MAX_UINT128.times('10').plus('1'),
  // MAX_UINT128.times('1000').minus('1'),
  // MAX_UINT128.times('1000'),
  // MAX_UINT128.times('1000').plus('1'),
  ...
  MAX_UINT192.div('10000').dp(0).minus('1'),
  MAX_UINT192.div('10000').dp(0),
  MAX_UINT192.div('10000').dp(0).plus('1'),
  MAX_UINT192.div('10').dp(0).minus('1'),
  MAX_UINT192.div('10').dp(0),
  MAX_UINT192.div('10').dp(0).plus('1'),
  ...
  MAX_UINT192.plus('1'),
  MAX_UINT192.plus('2'),
  MAX_UINT192.times('2').dp(0).minus('1'),
  MAX_UINT192.times('2').dp(0),
  MAX_UINT192.times('2').dp(0).plus('1'),
  MAX_UINT192.times('10').dp(0).minus('1'),
  MAX_UINT192.times('10').dp(0),
  MAX_UINT192.times('10').dp(0).plus('1'),
  MAX_UINT192.times('10000').dp(0).minus('1'),
  MAX_UINT192.times('10000').dp(0),
  MAX_UINT192.times('10000').dp(0).plus('1'),
